...
const Construccion: React.FC = () => {
  ...
  useDocumentHead({
    ...
    keywords:
      'desarrollo software escalable, metodología espiral, aplicaciones web PYMEs, sistemas información Bogotá',
  ...
  useEffect(() => {
    const checkVideoSupport = () => {
      ...
      const hasGoodConnection =
        !connection || connection.effectiveType === '4g' || connection.downlink > 1.5;
        ...
        <section className="container-hero-content-left">
          <div className="container-hero-content-info">
            <div className="container-hero-content-info-title">
              ...
              <p>
                Desarrollamos software escalable donde los clientes se apropian de su negocio
                digital
              </p>
            </div>
            <div className="container-hero-content-info-cards">
              <div className="card">
                ...
                <p>
                  Desarrollamos sistemas robustos utilizando nuestra metodología en espiral
                  patentada. Cada proyecto se construye con visión de futuro, implementando las
                  mejores prácticas de arquitectura de software para garantizar escalabilidad,
                  mantenibilidad y rendimiento óptimo a largo plazo.
                </p>
              </div>
              <div className="card">
                <span> Diseño de sotware </span>
                <p>
                  Creamos experiencias digitales que no solo se ven bien, sino que resuelven
                  problemas reales. Cada interfaz se diseña pensando en la usabilidad, accesibilidad
                  y conversión, garantizando que tus usuarios encuentren exactamente lo que buscan.
                </p>
              </div>
            </div>
          </div>
